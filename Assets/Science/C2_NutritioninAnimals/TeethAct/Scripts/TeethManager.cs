...
{
    [Header("Tooth Groups")]
    public TeethHighlighter incisorsHighlighter;
    public TeethHighlighter caninesHighlighter;
    public TeethHighlighter premolarsHighlighter;
    public TeethHighlighter molarsHighlighter;
